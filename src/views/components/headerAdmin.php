        ...
        <div class="flex items-center justify-between py-4 px-6">
            ...
            <div class="relative">
                <input type="text" placeholder="Search..." 
                       class="w-50 px-4 py-2 rounded-full bg-white text-gray-800 placeholder-gray-400 shadow focus:outline-none focus:ring-2 focus:ring-green-400">
                       <i class='bx bx-search-alt-2  absolute right-2 top-3 h-6 w-6 text-black z-10'></i>
         </div>
                <!-- Notification Icon -->
